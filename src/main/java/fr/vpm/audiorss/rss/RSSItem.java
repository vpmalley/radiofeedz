...
public class RSSItem implements Serializable{
  ...
  public static final String CHANNELTITLE_KEY = "channelTitle";
	...
	String channelImageUri = "";

  String localUri = "";
  
  long channelImageId = -1;
  ...
  long mediaId = -1;  
	...
	public RSSItem(String feedTitle, String title, String link, String description,
			String authorAddress, String category, String comments,
			String mediaUrl, String guid, String pubDate) {
		super();
  ...
  public void setChannelImage(String mediaUri) {
    this.channelImageUri = mediaUri; 
  }

  public void setChannelImageId(long id){
    channelImageId = id;
  }  

  public synchronized void setMediaUri(String mediaUri) {
    this.localUri = mediaUri; 
  }

  public synchronized Uri getMediaUri() {
    return Uri.parse(localUri);
  }
  
  public synchronized void setMediaId(long id){
    mediaId = id;
  }
  ...
  public Uri getChannelImage() {
    return Uri.parse(channelImageUri);
  }
}
