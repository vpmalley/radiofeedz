...
public class RSSChannel implements Parcelable {
  ...
  public static final String RSS_DATE_PATTERN_TZ_4D = "EEE, dd MMM yyyy HH:mm:ss ZZZ";
  public static final String RSS_DATE_PATTERN_TZ_2D_2D = "EEE, dd MMM yyyy HH:mm:ss ZZZZZ";
  ...
  public void saveToDb(ProgressListener progressListener, DataModel dataModel) throws ParseException {
    ...
    asyncDbUpdater.executeOnExecutor(AsyncTask.SERIAL_EXECUTOR, this);
  }
